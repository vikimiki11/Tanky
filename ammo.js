...
ammoList.push(new Ammo("7", "xd", "smallMissile.png", 10, 1000, 10, console.log))
ammoList.push(new Ammo("8", "xd", "smallMissile.png", 10, 1000, 10, console.log))
ammoList.push(new Ammo("9", "xd", "smallMissile.png", 10, 1000, 10, console.log))
ammoList.push(new Ammo("10", "xd", "smallMissile.png", 10, 1000, 10, console.log))
ammoList.push(new Ammo("11", "xd", "smallMissile.png", 10, 1000, 10, console.log))
ammoList.push(new Ammo("12", "xd", "smallMissile.png", 10, 1000, 10, console.log))
ammoList.push(new Ammo("13", "xd", "smallMissile.png", 10, 1000, 10, console.log))
ammoList.push(new Ammo("14", "xd", "smallMissile.png", 10, 1000, 10, console.log))
